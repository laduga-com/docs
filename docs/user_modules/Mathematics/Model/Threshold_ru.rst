...
.. csv-table:: **Паспорт**
   ...
   "PAR", "int", "Число параметров простого типа","3"
...
.. csv-table:: **Параметры**
   ...
   "VL", "real", "Нижнее значение выходного сигнала", "0"
   "VH", "real", "Верхнее значение выходного сигнала", "1.0"
